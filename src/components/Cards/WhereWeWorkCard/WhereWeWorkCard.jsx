...
const WhereWeWorkCard = ({ image, title, desc, members }) => {
  return (
    <div
      class="flex flex-col justify-between w-72 sm:w-72 h-72 bg-white bg-center bg-cover text-gray-800 shadow-md overflow-hidden cursor-pointer"
    ...
    >
      ...
      <div class="bg-white bg-opacity-95 shadow-md rounded-r-xl p-1 flex flex-col mr-4 mb-8">
        <h3 class="text-lg font-bold pb-2">{title}</h3>
