const ContactUs = () => {
    ...
    const contactMethods = [
        ...
        },
        {
            ...
            ,
            contact: "Andheri West, Mumbai, India."
        },
    ]

    return (
        <main className="min-h-dvh grid place-items-center">
            <div className="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8 w-full">
