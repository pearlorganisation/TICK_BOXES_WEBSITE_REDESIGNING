...
const HeroSection = () => {
    ...
    return (
        <section className="min-h-[91.5vh] grid place-items-center">
            <div className="max-w-screen-xl mx-auto px-4 py-28 gap-12 text-gray-600 md:px-8 xl:flex min-h-[30rem]">
                <div className="space-y-8 max-w-2xl mx-auto text-center xl:text-left">
                    ...
                    <h1 className="text-4xl text-gray-800 font-extrabold mx-auto md:text-5xl">
                        Simplitfy Your society Management
                    </h1>
                ...
                <div className="flex-1 max-w-xl mx-auto mt-14 xl:mt-0">
                    <div className="relative">
                        <img src="https://images.unsplash.com/photo-1513258496099-48168024aec0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" className="rounded-lg w-full h-full" alt="" />
                    ...
                    <div className="fixed inset-0 w-full h-full flex items-center justify-center">
                        ...
                        <div className="px-4 relative">
                            ...
                            <video className="rounded-lg w-full max-w-2xl" controls autoPlay={true}>
                                <source src="https://vod-progressive.akamaized.net/exp=1708776271~acl=%2Fvimeo-prod-skyfire-std-us%2F01%2F1237%2F16%2F406187011%2F1739831782.mp4~hmac=f6b00ea561e3276357a643bbe693682c90243cb20efb0a4206b73edbf20f4f8c/vimeo-prod-skyfire-std-us/01/1237/16/406187011/1739831782.mp4" type="video/mp4" />
                            </video>
                        </div>
                    </div>
                ) : ""
